...
public class DescriptionFieldEmpty_Copy extends Simulation {
    ...
    ScenarioBuilder postApiScenario = scenario("POST API Request with Token1")
...

    {
        ...
        setUp(
                postApiScenario.injectOpen(atOnceUsers(100))
